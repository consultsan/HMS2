...
export default function Admins() {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: string; data: Partial<Admin> }) =>
      superAdminApi.updateAdmin(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['admins'] });
      setIsOpen(false);
      reset();
  ...
  const isLoading = isLoadingAdmins || isLoadingHospitals;
      ...
      <div className="sm:flex sm:items-center bg-re">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            A list of all hospital admins in your system
          </p>
        </div>
            ...
            <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
              {isLoading ? (
                <div className="p-4 text-center">
                  <span className="animate-pulse">Loading admins...</span>
                </div>
              ) : (
