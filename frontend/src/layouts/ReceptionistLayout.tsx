...
const sidebarSections = [
    ...
    },
    {
        ...
        path: '/receptionist/surgical-appointments',
    },
];
...
export default function ReceptionistLayout() {
    ...
    const getSearchPlaceholder = () => {
        if (location.pathname.includes('/receptionist/patients')) {
            return 'Search by name or phone number';
        } else if (location.pathname.includes('/receptionist/appointments')) {
            return 'Search by patient name or appointment date';
        }
        return 'Search...';
    };
        ...
        <div className="min-h-screen flex bg-gray-50">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <header className="h-16 bg-[#154D92] px-6 flex justify-between items-center">
                    <div className={`flex items-center ${location.pathname.includes('/receptionist/dashboard') ? 'invisible' : 'visible'}`}>
